...
def get_presigned_product():
    ...
    try:
        presigned_product = s3_client.generate_presigned_product(
        ...
        presigned_product["filename"] = filename

        return presigned_product
